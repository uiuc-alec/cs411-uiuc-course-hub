...
const dbUsername = process.env.CS411_DB_USERNAME;
const dbPassword = process.env.CS411_DB_PASSWORD;
const dbName = process.env.CS411_DB_NAME;
const dbHost = process.env.CS411_DB_HOST;

// Database connection setup
var db = mysql.createConnection({
  host: dbHost,  // GCP database host
